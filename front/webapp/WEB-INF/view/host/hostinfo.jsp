...
<link rel="stylesheet" href="${pageContext.request.contextPath}/webapp/assets/css/info.css?after">
					...
					<div id="hostimgbox" class="col-xs-3">
						<c:choose>
							<c:when test="${empty requestScope.hostMap.hostVo.path}">
								<img id="hostimg" src="${pageContext.request.contextPath}/webapp/assets/images/hostinfo_sample.jpg" alt="PetSitter Image" class="img-circle">
							</c:when>
							<c:otherwise>
										...
										<div class="reviewbox">
											<div class="row reviewinfo">
												<c:choose>
													...
													<c:otherwise>
														<img class="img-circle reviewimg" src="${pageContext.request.contextPath}/webapp/assets/images/hostinfo_sample.jpg">
													</c:otherwise>
												</c:choose>
