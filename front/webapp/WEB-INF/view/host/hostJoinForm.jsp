...
<head>
	...
	<link href="${pageContext.request.contextPath}/webapp/assets/css/hostJoin.css" rel="stylesheet" type="text/css">
        ...
        <div id="container" class="clearfix">
      		<div id="joinform" class="col-xs-8">
            	<div style="text-align:center;">
            		<img src="${pageContext.request.contextPath}/webapp/assets/images/hostjoin_dogicon1.png" width="50px" style="padding:0px 0px 10px 0px">
