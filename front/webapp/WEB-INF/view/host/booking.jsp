...
<!--CSS-->
<link href="${pageContext.request.contextPath}/webapp/assets/css/bookingForm.css?after" rel="stylesheet" type="text/css"/>
<link href="${pageContext.request.contextPath}/webapp/assets/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/assets/bootstrap/css/bootstrap-datepiker.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/webapp/assets/css/finishR.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/webapp/assets/css/fullcalendar.min.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/webapp/assets/js/bootstrap-datepiker.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/webapp/assets/js/bootstrap-datepiker.ko.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/webapp/assets/js/fullcalendar.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/webapp/assets/js/locales-all.min.js"></script>
            ...
            <div id="hostprofile" class="col-xs-4">
                <div id="profile" class="row">
                	<c:choose>
                		...
                		<c:otherwise>
                			<img id="hostimg" src="${pageContext.request.contextPath}/webapp/assets/images/hostinfo_sample.jpg" class="img-circle">
                		</c:otherwise>
                	</c:choose>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
	            <img id="checked"  src="${pageContext.request.contextPath}/webapp/assets/images/finishR_check2-circle.svg">
