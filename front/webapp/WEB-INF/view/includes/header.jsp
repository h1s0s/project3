...
<!-- CSS -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/webapp/assets/css/header.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/webapp/assets/css/login.css">
...
<!-- 	
    ...
    <script src="${pageContext.request.contextPath}/webapp/assets/js/litepicker.js"></script>
