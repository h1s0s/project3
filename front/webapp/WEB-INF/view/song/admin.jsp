...
<head>
	...
	<link href="${pageContext.request.contextPath}/webapp/assets/css/admin.css" rel="stylesheet" type="text/css">
    <!-- Custom styles for this template-->
	<script src="${pageContext.request.contextPath}/webapp/assets/js/jquery-1.12.4.js"></script>
	<script src="${pageContext.request.contextPath}/webapp/assets/bootstrap/js/bootstrap.js"></script>
</head>
...
<body>     
    ...
    <script src="${pageContext.request.contextPath}/webapp/assets/js/vendor/jquery/jquery.min.js"></script>
    <script src="${pageContext.request.contextPath}/webapp/assets/js/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="${pageContext.request.contextPath}/webapp/assets/js/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="${pageContext.request.contextPath}/webapp/assets/js/admin.js"></script>

    <!-- Page level plugins -->
    <script src="${pageContext.request.contextPath}/webapp/assets/js/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="${pageContext.request.contextPath}/webapp/assets/js/chart-area.js"></script>
