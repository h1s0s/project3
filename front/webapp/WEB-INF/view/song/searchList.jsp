...
<html>
	<head>
	    ...
	    <link rel="stylesheet" href="${pageContext.request.contextPath}/webapp/assets/css/searchList.css" type="text/css">
			                	...
			                	<div class="search_cursor_pointer" onclick="location.href='/project/host/info/${searchListVo.hostNo}';">
			                        ...
			                        <c:choose>
										<c:when test="${empty searchListVo.path}">
											<img class="result-img" src="${pageContext.request.contextPath}/webapp/assets/images/hostinfo_sample.jpg">
										</c:when>
										<c:otherwise>
