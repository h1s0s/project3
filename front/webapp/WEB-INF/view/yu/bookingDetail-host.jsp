...
<title>Insert title here</title>
    ...
    <link href="${pageContext.request.contextPath}/webapp/assets/css/booking.css" rel="stylesheet" type="text/css"/>
	<link href="${pageContext.request.contextPath}/webapp/assets/css/poto-upload.css" rel="stylesheet" type="text/css"/>
	<link href="${pageContext.request.contextPath}/webapp/assets/css/myDog.css" rel="stylesheet" type="text/css">
										...
										<form action="">
											<div id="imgFile" data-usersno="${bvo.usersNo}">
												<c:if test="${empty mvo.photo}">
													<img id="myDogImg" src="${pageContext.request.contextPath}/webapp/assets/images/myDogImg2.png">
												</c:if>
												<c:if test="${!empty mvo.photo}">
